...
export const coin = (
  ...
  >
    <rect width="43" height="52" fill="url(#pattern0)" />
    <defs>
      <pattern
        id="pattern0"
      ...
      >
        <use
          xlinkHref="#image0_21_340"
          transform="translate(0 -0.00157629) scale(0.0163934 0.0135561)"
        />
      </pattern>
      <image
        id="image0_21_340"
